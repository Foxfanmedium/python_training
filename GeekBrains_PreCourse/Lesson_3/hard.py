...
def get_person_to_filename(filename):
    person = {}
...
def attack(who_attack, who_defend):
    ...
    print('{}нанес {}урона  {},у того осталось {} жизней'.format(who_attack['name'],
                                                                 who_defend['health']))
...
def start_game():
    player = get_person_to_filename(player_name)
    enemy = get_person_to_filename(enemy_name)
