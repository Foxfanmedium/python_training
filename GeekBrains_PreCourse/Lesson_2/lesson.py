...
# name = 'РёРІРђРЅ РїР•С‚Р РѕРІ РїР•'
# print(name.title())
# print(name.capitalize())
# print(name.upper())
# print(name.lower())
# print(name.find('РїР•', 6))
#
# name = 'РРІР°РЅ'
# surname = 'РџРµС‚СЂРѕРІ'
# age = 20
# print('РџСЂРёРІРµС‚СЃС‚РІСѓСЋ С‚РµР±СЏ - ' + name + ' ' + surname + ', РєРѕС‚РѕСЂРѕРјСѓ ' + str(age) + ' Р»РµС‚')
# print('РџСЂРёРІРµС‚СЃС‚РІСѓСЋ С‚РµР±СЏ - %s %s, РєРѕС‚РѕСЂРѕРјСѓ %i Р»РµС‚' % (name, surname, age))
# print('РџСЂРёРІРµС‚СЃС‚РІСѓСЋ С‚РµР±СЏ - {} {}, РєРѕС‚РѕСЂРѕРјСѓ {} Р»РµС‚'.format(name, surname, age))
# print(f'РџСЂРёРІРµС‚СЃС‚РІСѓСЋ С‚РµР±СЏ - {name} {surname}, РєРѕС‚РѕСЂРѕРјСѓ {age} Р»РµС‚')
